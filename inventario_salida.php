...
WHERE 
	id_articulo	= '".$_GET['id']."' 
";
$venta = mysql_fetch_array(mysql_query($sql));
?>

<script src="include/func.js" type="text/javascript"></script>

<fieldset>
<legend>Detalles de salida de inventario</legend>
...
<table>
	<tr>
        ...
        <fieldset>
        	...
        	<table>
            	<tr>
                    ...
                    <td><?php echo $items_sql['nombre']?></td>
                </tr>
            	<tr>
        ...
        <td valign="top" width="300">
        	<fieldset>
            <legend>Salida de Inventario</legend>
            
            <form id="agregar_inventario" method="post" action="process/add_inventario.php?table=inventario_salida&url=../inventario.php">
            ...
            <input type="hidden" name="usuario" value="<?php echo $_SESSION['user'] ?>" />
                <table>
                    ...
                    <tr>
                        <td>Precio:</td>
                        <td><input type="text" name="precio" value="<?php echo number_format($venta[0],2); ?>" style="width:50px;" autocomplete="off"/><em>Precio de venta</em></td>
                    </tr>
                    <tr>
                    	<td></td>
                        <td>
                        <input type="button" value="Dar Salida" onclick="novacio_from('agregar_inventario')" class="control"/>
