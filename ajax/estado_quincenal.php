...
Const_header("Estado de cuenta Semanal");
...
$sql_2 = "FROM registro ";
$sql_3 = "WHERE ID_CLIENTE = '".$_GET['id']."' AND fecha <=  LAST_DAY(DATE_SUB(CURDATE(), INTERVAL 2 MONTH))";
...
$Sql_2 = "FROM registro ";
$Sql_3 = "WHERE ID_CLIENTE = '".$_GET['id']."' AND MONTH(fecha) =  MONTH(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)) AND YEAR(fecha)=YEAR(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)) ";
...
$resql_3 = "WHERE ID_CLIENTE = '".$_GET['id']."' AND MONTH(fecha) =  MONTH(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)) AND YEAR(fecha)=YEAR(DATE_SUB(CURDATE(), INTERVAL 1 MONTH)) ";
...
<tr>
<td colspan="9">Estado al  <?php echo $fecha_estado[0];  echo nombreMes($fecha_estado[1]);  echo 'del '.$fecha_estado[2];?> </td>
<td colspan="9"><?php echo number_format($tutto_ant,2);?></td>
</tr>
<?php
	...
	<table>
    	<tr>
       	...
       	<tr>
            ...
            <td><input type="text" id="fiscal"/></td>
        </tr>
       	<tr>
        	<td></td>
