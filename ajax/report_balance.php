...
while($cliente = mysql_fetch_array($client_query)):
	...
	if($resultado < 3):
  		...
  		//BUSCAR FACTURAS DE LOS CLIENTES EN FECHA DE
...
<div id="imprimirReporte">
	<a href="#" class="botton" onclick="abrirPopUp('printReporte/ventas.php?inicio=<?php echo $_GET['f1'] ?>&fin=<?php echo $_GET['f2'] ?>','200','300','Reporte de Venta')">Imprimir este Reporte</a>
</div>