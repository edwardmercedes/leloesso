...
<fieldset>
	<legend>Perzonalizar detalles de salida</legend>
    ...
    <table>
    	<tr>
            ...
            <td>
             ...
             <td width="50">&nbsp;</td>
			<td><input type="button" value="Perzonalizar" class="control" onclick="pesonar('perzonalizar','s')" /></td>
        </tr>
    </table>
  </form>
</fieldset>
...
<h2 style="color:#FFF;">Detalles de salida de inventario</h2>
<?php    
}
?>
<div id="cargar_dos">
...
<?php 
	...
	?>
        ...
        <tr>
            <td>100-<?php echo $row['id_salida'] ?></td>
