...
if (!empty($_POST['filename'])) { 
	...
	$command = "C:\AppServ\mysql\bin\mysqldump.exe ".$dbarg." -u ".$_POST['mysqluser'].
...
Backup ¿ de que ?<br />
<input type="radio" name="backupall" value="true" id="backupallTrue" />
