...
<table cellpadding="0" cellspacing="0" class="masther" border="0" width="700">
<tr>
	<th>Fecha</th>
    <th>No. Fact</th>
    <th>Ficha</th>
    ...
    <th>Combust.</th>
    <th>Precio</th>
    <th class="derecha">Valor Fact</th>
...
<tr>
<td colspan="10" class="izquierda" align="left">Balance al  <?php echo $fecha_estado[0];  echo nombreMes($fecha_estado[1]);  echo 'del '.$fecha_estado[2];?> </td>
<td class="print">&nbsp;</td>
<td class="derecha"><?php echo number_format($tutto_ant,2);?></td>
</tr>
<?php
...
//BANCOS	
	if(!empty($mes['banco'])){
		echo '<td  class="print">'.$mes['banco'].' &nbsp;</td>';
	}
	else{
...
//carcular balance
 ...
 //TRAFORMAR NEGATIVO EN POSITIVO
	if($tutto > 0){
		echo '<td class="derecha">'.number_format($tutto,2).'</td>';
	}
	else{
		$tu = $tutto * -1;
		echo '<td class="derecha">'.number_format($tu,2).'</td>';	
	}	
echo '</tr>';	
}
?>
	...
	<table>
    	<tr>
       	...
       	<tr>
            ...
            <td><input type="text" id="fiscal" value="A0100100101000000<?php echo $ncf; ?>"/></td>
        </tr>
       	<tr>
        	<td></td>
